...
public class Sintatico implements Constants
{
    ...
    private boolean step(String input) throws LexicalError, SyntaticError, SemanticError
    {
        if (currentToken == null)
        {
            ...
            currentToken = new Token(DOLLAR, "$", pos, this.scanner.getPositionLine(pos));
        }
        ...
        else if (isTerminal(x))
        {
            ...
            {
                throw new SyntaticError("encontrado "+currentToken.getLexeme()+" "+PARSER_ERROR[x], currentToken.getPosition(), currentToken.getLine());
            }
        }
